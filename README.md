...
py -0 # Para revisar versiones instaladas
py -3.11 -m venv .venv # Crear entorno virtual con py 3.11
Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope Process # Para ejecutar scripts locales sin firmar 
